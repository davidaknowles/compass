...
The proximal step begins at a common high-throughput value and uses objective-based backoff. If a proposed update increases the penalized objective beyond numerical tolerance, the previous accepted state is restored and the step is halved. This permits larger steps at strongly regularized points while maintaining descent at weaker penalties.
