...
As an ABC-independent regulatory comparison, we jointly fit binary ATAC-seq, H3K27ac, and H3K4me3 peak annotations from human NeuN neuron, PU1 microglia, Olig2 oligodendrocyte, and LHX2 astrocyte nuclei, again conditional on BaselineLD. The total observed-scale estimate was $h^2=0.0151\;(\mathrm{SE}=0.0022)$ with intercept $1.0160\;(\mathrm{SE}=0.0146)$. PU1 microglial H3K27ac peaks covered 2.72\% of SNPs, accounted for 40.0\% of the fitted $h^2$ (SE 10.4\%), and had 14.7-fold enrichment (SE 3.82; enrichment $p=1.36\times10^{-4}$). Its conditional coefficient was positive ($3.26\times10^{-8}$; SE $1.47\times10^{-8}$; $z=2.22$; nominal $p=0.026$). The other 11 peak annotations were not resolved. The coefficient does not survive Benjamini--Hochberg correction across the 12 custom peak annotations ($q\approx0.31$), so this is a coherent microglial-H3K27ac signal for follow-up rather than a corrected discovery.
