...
\begin{equation}
    B_{kl} = s\,q_l + D_{kl}, \qquad s\ge 0,\quad q_l\ge 0,\quad D_{kl}\ge 0,
...
\begin{equation}
    H_l^{\mathrm{global}}=c_l s q_l,\qquad
