...
- Added objective-based hierarchical step adaptation. An uphill proximal update is rejected, the last accepted coefficient/context/residual state is restored, and the step is halved. Replaying the unstable AD `lambda=3` fit started at `3e-7`, rejected the first uphill update, and descended monotonically after automatic backoff. The provisional held-out MSE was `38.5172`, worse than `lambda=10`, while microglia remained the leading context at 51.2%. Hierarchical fits now start at `3e-7` and adapt downward; other methods retain `1e-8`.
- Replaced the slow production allocations after preserving their atomic state. The accelerated AD chain is `19286275`, `19286276`, and `19286277`, followed by context-summary job `19286278`. After the one-time SCZ fold sidecar completed, job `19286310` began an independent L40S warm-up and wrote a verified frozen checkpoint with neuron `4.22e-7`, astrocyte `0.85e-7`, oligodendrocyte `0.65e-7`, and microglia zero. Its runtime is bounded at 70 minutes, after which B6K continuations `19286427`, `19286428`, and `19286429` resume the checkpoint, followed by summary job `19286430`. The superseded L40S continuations were cancelled. All active submitted scripts request frozen scaling and `lr=1e-7`.
