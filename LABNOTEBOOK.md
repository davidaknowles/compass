...
- Replaced the slow production allocations after preserving their atomic state. The accelerated AD chain is `19286275`, `19286276`, and `19286277`, followed by context-summary job `19286278`. After the one-time SCZ fold sidecar completed, the accelerated SCZ chain was moved to an independent GPU allocation as `19286310`, `19286311`, and `19286312`, followed by summary job `19286313`. Both submitted scripts were verified to request frozen scaling and `lr=1e-7`.
